...
export name='Mayara Fernandes Pinto'
export email="mayara.fernandes2@etec.sp.gov.br"
export repositorio="https://github.com/MayaraFernandesP/PAM-II";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="cinemay-$(date +%Y%m%d)"
